...
class TestId(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.worker1 = Worker(self.person2, datetime.date(2010, 3, 12), True, 30000, 'Teacher')
        ...
        self.worker2 = Worker(self.person3, datetime.date(2010, 3, 12), True, 40000, 'Registrar')
        self.registrar1 = Registrar(self.person3, self.worker2, "ogormez", "gormez*123-*")
        ...
        self.worker3 = Worker(self.person4, datetime.date(2010, 3, 12), True, 40000, 'Admin')
    ...
    def test_get_contact_info(self):
        ...
        self.assertEqual(self.person1.get_contact_info(),("05336833244", "02129854478", "batuhan_hangun@mymail.com", '59/5, Maslak, İstanbul'))

    def test_update_email(self):
        print("test_update_email")
        self.assertEqual(self.student1.update_email("batuhanhangun@mymail.com"),"batuhanhangun@mymail.com")
